...
from .flow.configuration_flow import FlowConfig
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    Args:
        name: The name of the policy. Supported names are "tdmpc", "diffusion", "flow", "act",
    ...
    if name == "tdmpc":
        ...
        from .flow.modeling_flow import FlowPolicy
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    Args:
        policy_type: The type of the policy. Supported types include "tdmpc",
                     "multi_task_dit", "diffusion", "flow", "act", "vqbet", "pi0", "pi05", "gaussian_actor",
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if isinstance(policy_cfg, TDMPCConfig):
        ...
        from .flow.processor_flow import make_flow_pre_post_processors
