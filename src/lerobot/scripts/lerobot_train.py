...
def update_policy(
    ...
    Args:
        ...
        step: Current global optimization step before this update.
    ...
    if step is not None and has_method(unwrapped_policy, "set_train_step"):
        unwrapped_policy.set_train_step(step)
