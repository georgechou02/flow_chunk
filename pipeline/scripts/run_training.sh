...
USE_JVP_AK="${USE_JVP_AK:-false}"
USE_1_K="${USE_1_K:-false}"
ENABLE_STOCHASTIC="${ENABLE_STOCHASTIC:-false}"
...
cmd+=(
  ...
  --policy.use_1_k="$USE_1_K"
  --policy.gripper_first=false
  --policy.enable_stochastic="$ENABLE_STOCHASTIC"
