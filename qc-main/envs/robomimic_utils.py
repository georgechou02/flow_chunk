...
def _import_robomimic():
    """Import robomimic only when a robomimic env/dataset is actually used."""
    global EnvUtils, FileUtils, ObsUtils, DATASET_REGISTRY, _ROBOMIMIC_READY
    if _ROBOMIMIC_READY:
        return
    ...
    from robomimic import DATASET_REGISTRY as _DATASET_REGISTRY
