...
flags.DEFINE_integer('ratio', 1, 'D4RL small-sample ratio. 1 uses the full dataset.')
flags.DEFINE_string('small_samples_dir', '/home/chengpeng/small_samples', 'Directory of subsampled D4RL npys.')
...
def main(_):
    ...
    if FLAGS.ogbench_dataset_dir is not None:
        ...
        env, eval_env, train_dataset, val_dataset = make_env_and_datasets(
            FLAGS.env_name,
            ratio=FLAGS.ratio,
            small_samples_dir=FLAGS.small_samples_dir,
        )
